...
@Component(immediate = true,property = "indexer.class.name=com.marketplace.category.model.Category", service = KeywordQueryContributor.class)
public class CategoryKeywordQueryContributor implements KeywordQueryContributor {
