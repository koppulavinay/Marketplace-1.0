...
@Component(immediate = true, property = "indexer.class.name=com.marketplace.category.model.Category", service = ModelSummaryContributor.class)
public class CategoryModelSummaryContributor implements ModelSummaryContributor {
