...
/**
 * Provides the local service utility for SpecFieldDataType. This utility wraps
 * <code>com.marketplace.specification.field.data.type.service.impl.SpecFieldDataTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SpecFieldDataTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.marketplace.specification.field.data.type.service.impl.SpecFieldDataTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SpecFieldDataType addSpecFieldDataType(
		SpecFieldDataType specFieldDataType) {

		return getService().addSpecFieldDataType(specFieldDataType);
	}
	 ...
	 */
	public static SpecFieldDataType createSpecFieldDataType(
		long specFieldDataTypeId) {

		return getService().createSpecFieldDataType(specFieldDataTypeId);
	}
	 ...
	 */
	public static SpecFieldDataType deleteSpecFieldDataType(
			long specFieldDataTypeId)
		throws PortalException {

		return getService().deleteSpecFieldDataType(specFieldDataTypeId);
	}
	...
	public static SpecFieldDataType deleteSpecFieldDataType(
		...
		return getService().deleteSpecFieldDataType(specFieldDataType);
	}
	...
	public static SpecFieldDataType fetchSpecFieldDataType(
		long specFieldDataTypeId) {

		return getService().fetchSpecFieldDataType(specFieldDataTypeId);
	}
	 ...
	 * @throws PortalException if a spec field data type with the primary key could not be found
	 */
	public static SpecFieldDataType getSpecFieldDataType(
			long specFieldDataTypeId)
		throws PortalException {

		return getService().getSpecFieldDataType(specFieldDataTypeId);
	}
	 ...
	 */
	public static List<SpecFieldDataType> getSpecFieldDataTypes(
		int start, int end) {

		return getService().getSpecFieldDataTypes(start, end);
	}
	 ...
	 */
	public static int getSpecFieldDataTypesCount() {
		return getService().getSpecFieldDataTypesCount();
	}
	 ...
	 */
	public static SpecFieldDataType updateSpecFieldDataType(
		SpecFieldDataType specFieldDataType) {

		return getService().updateSpecFieldDataType(specFieldDataType);
	}

	public static SpecFieldDataTypeLocalService getService() {
		return _service;
	}

	private static volatile SpecFieldDataTypeLocalService _service;
