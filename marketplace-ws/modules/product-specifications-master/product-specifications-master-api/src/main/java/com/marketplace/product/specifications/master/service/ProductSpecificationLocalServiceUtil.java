...
/**
 * Provides the local service utility for ProductSpecification. This utility wraps
 * <code>com.marketplace.product.specifications.master.service.impl.ProductSpecificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductSpecificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.marketplace.product.specifications.master.service.impl.ProductSpecificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProductSpecification addProductSpecification(
		ProductSpecification productSpecification) {

		return getService().addProductSpecification(productSpecification);
	}
	 ...
	 */
	public static ProductSpecification createProductSpecification(
		long productSpecificationId) {

		return getService().createProductSpecification(productSpecificationId);
	}
	 ...
	 */
	public static ProductSpecification deleteProductSpecification(
			long productSpecificationId)
		throws PortalException {

		return getService().deleteProductSpecification(productSpecificationId);
	}
	...
	public static ProductSpecification deleteProductSpecification(
		...
		return getService().deleteProductSpecification(productSpecification);
	}
	...
	public static ProductSpecification fetchProductSpecification(
		long productSpecificationId) {

		return getService().fetchProductSpecification(productSpecificationId);
	}
	...
	public static ProductSpecification
		fetchProductSpecificationByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchProductSpecificationByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a product specification with the primary key could not be found
	 */
	public static ProductSpecification getProductSpecification(
			long productSpecificationId)
		throws PortalException {

		return getService().getProductSpecification(productSpecificationId);
	}
	 ...
	 */
	public static ProductSpecification getProductSpecificationByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getProductSpecificationByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static List<ProductSpecification> getProductSpecifications(
		...
		return getService().getProductSpecifications(start, end);
	}
	 ...
	 */
	public static List<ProductSpecification>
		getProductSpecificationsByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getProductSpecificationsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProductSpecificationsCount() {
		return getService().getProductSpecificationsCount();
	}
	 ...
	 */
	public static ProductSpecification updateProductSpecification(
		ProductSpecification productSpecification) {

		return getService().updateProductSpecification(productSpecification);
	}

	public static ProductSpecificationLocalService getService() {
		return _service;
	}

	private static volatile ProductSpecificationLocalService _service;
