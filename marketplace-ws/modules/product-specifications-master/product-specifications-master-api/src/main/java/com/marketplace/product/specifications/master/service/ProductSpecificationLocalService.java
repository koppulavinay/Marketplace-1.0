...
/**
 * Provides the local service interface for ProductSpecification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProductSpecificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProductSpecificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.product.specifications.master.service.impl.ProductSpecificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the product specification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProductSpecificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<ProductSpecification> findByDraftProductId(long draftProductId);
	...
	public List<ProductSpecification>
		getProductSpecificationsByUuidAndCompanyId(String uuid, long companyId);
