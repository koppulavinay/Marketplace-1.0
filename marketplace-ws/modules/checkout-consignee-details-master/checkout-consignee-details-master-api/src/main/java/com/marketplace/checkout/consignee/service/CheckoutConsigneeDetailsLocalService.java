...
/**
 * Provides the local service interface for CheckoutConsigneeDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CheckoutConsigneeDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CheckoutConsigneeDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.checkout.consignee.service.impl.CheckoutConsigneeDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the checkout consignee details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CheckoutConsigneeDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CheckoutConsigneeDetails addCheckoutConsigneeDetails(
	...
	public CheckoutConsigneeDetails createCheckoutConsigneeDetails(
	...
	public CheckoutConsigneeDetails deleteCheckoutConsigneeDetails(
		CheckoutConsigneeDetails checkoutConsigneeDetails);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutConsigneeDetails fetchCheckoutConsigneeDetails(
		long checkoutConsigneeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutConsigneeDetails
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutConsigneeDetails getCheckoutConsigneeDetails(
			long checkoutConsigneeId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CheckoutConsigneeDetails> getCheckoutConsigneeDetails(
		long parentCartId, long orderItemId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutConsigneeDetails getCheckoutConsigneeDetailsByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CheckoutConsigneeDetails> getCheckoutConsigneeDetailses(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CheckoutConsigneeDetails>
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CheckoutConsigneeDetails updateCheckoutConsigneeDetails(
		CheckoutConsigneeDetails checkoutConsigneeDetails);
