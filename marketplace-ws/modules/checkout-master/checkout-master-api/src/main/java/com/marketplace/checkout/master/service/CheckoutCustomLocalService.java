...
/**
 * Provides the local service interface for CheckoutCustom. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CheckoutCustomLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CheckoutCustomLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.checkout.master.service.impl.CheckoutCustomLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the checkout custom local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CheckoutCustomLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CheckoutCustom addCheckoutCustom(CheckoutCustom checkoutCustom);
	...
	public CheckoutCustom createCheckoutCustom(long checkoutCustomId);
	...
	public CheckoutCustom deleteCheckoutCustom(CheckoutCustom checkoutCustom);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CheckoutCustom deleteCheckoutCustom(long checkoutCustomId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutCustom fetchCheckoutCustom(long checkoutCustomId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CheckoutCustom getCheckoutCustom(long checkoutCustomId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CheckoutCustom> getCheckoutCustoms(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CheckoutCustom updateCheckoutCustom(CheckoutCustom checkoutCustom);
