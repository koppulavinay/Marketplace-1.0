 ...
 * <code>com.marketplace.product.master.service.impl.ProductLocalServiceImpl</code> and
...
public class ProductLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.marketplace.product.master.service.impl.ProductLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Product createProduct(long draftProductId) {
		return getService().createProduct(draftProductId);
	}
	 ...
	 */
	public static Product deleteProduct(long draftProductId)
		throws PortalException {

		return getService().deleteProduct(draftProductId);
	}
	...
	public static Product fetchProduct(long draftProductId) {
		return getService().fetchProduct(draftProductId);
	}
	...
	public static List<Product> findByProductWithStatusById(
		String vendorId, long categoryId, String organizationId,
		String productStatus, int start, int end) {

		return getService().findByProductWithStatusById(
	 ...
	 * @throws PortalException if a product with the primary key could not be found
	 */
	public static Product getProduct(long draftProductId)
		throws PortalException {

		return getService().getProduct(draftProductId);
	}
