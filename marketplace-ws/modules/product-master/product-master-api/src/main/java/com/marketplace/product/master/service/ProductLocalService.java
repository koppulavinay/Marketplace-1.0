...
public interface ProductLocalService
	...
	public Product createProduct(long draftProductId);
	...
	public Product deleteProduct(long draftProductId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product fetchProduct(long draftProductId);
	...
	public List<Product> findByProductWithStatusById(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product getProduct(long draftProductId) throws PortalException;
