...
public abstract class BaseInventoryResourceImpl implements InventoryResource {
	 ...
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/product-inventory-api-custom/v1.0/update-inventory' -d $'{"commerceOrderId": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.PATCH
	@javax.ws.rs.Path("/update-inventory")
	@Override
	public Response updateInventory(InventoryUpdateObject inventoryUpdateObject)
		throws Exception {
