...
/**
 * Provides the local service utility for ProductSpecValueMap. This utility wraps
 * <code>com.marketplace.product.spec.value.map.service.impl.ProductSpecValueMapLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductSpecValueMapLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.marketplace.product.spec.value.map.service.impl.ProductSpecValueMapLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProductSpecValueMap addProductSpecValueMap(
		ProductSpecValueMap productSpecValueMap) {

		return getService().addProductSpecValueMap(productSpecValueMap);
	}
	 ...
	 */
	public static ProductSpecValueMap createProductSpecValueMap(
		long productSpecValueId) {

		return getService().createProductSpecValueMap(productSpecValueId);
	}
	 ...
	 */
	public static ProductSpecValueMap deleteProductSpecValueMap(
			long productSpecValueId)
		throws PortalException {

		return getService().deleteProductSpecValueMap(productSpecValueId);
	}
	...
	public static ProductSpecValueMap deleteProductSpecValueMap(
		...
		return getService().deleteProductSpecValueMap(productSpecValueMap);
	}
	...
	public static ProductSpecValueMap fetchProductSpecValueMap(
		long productSpecValueId) {

		return getService().fetchProductSpecValueMap(productSpecValueId);
	}
	 ...
	 */
	public static ProductSpecValueMap fetchProductSpecValueMapByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchProductSpecValueMapByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static ProductSpecValueMap findByProductSpecIdNSpecValueId(
		...
		return getService().findByProductSpecIdNSpecValueId(
	...
	public static List<ProductSpecValueMap> findByProductSpecificationId(
		...
		return getService().findByProductSpecificationId(
	 ...
	 * @throws PortalException if a product spec value map with the primary key could not be found
	 */
	public static ProductSpecValueMap getProductSpecValueMap(
			long productSpecValueId)
		throws PortalException {

		return getService().getProductSpecValueMap(productSpecValueId);
	}
	 ...
	 */
	public static ProductSpecValueMap getProductSpecValueMapByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getProductSpecValueMapByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<ProductSpecValueMap> getProductSpecValueMaps(
		int start, int end) {

		return getService().getProductSpecValueMaps(start, end);
	}
	 ...
	 */
	public static List<ProductSpecValueMap>
		getProductSpecValueMapsByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getProductSpecValueMapsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProductSpecValueMapsCount() {
		return getService().getProductSpecValueMapsCount();
	}
	 ...
	 */
	public static ProductSpecValueMap updateProductSpecValueMap(
		ProductSpecValueMap productSpecValueMap) {

		return getService().updateProductSpecValueMap(productSpecValueMap);
	}

	public static ProductSpecValueMapLocalService getService() {
		return _service;
	}

	private static volatile ProductSpecValueMapLocalService _service;
