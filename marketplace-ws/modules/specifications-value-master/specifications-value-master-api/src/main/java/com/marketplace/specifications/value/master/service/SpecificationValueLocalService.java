...
/**
 * Provides the local service interface for SpecificationValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SpecificationValueLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SpecificationValueLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.specifications.value.master.service.impl.SpecificationValueLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the specification value local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SpecificationValueLocalServiceUtil} if injection and service tracking are not available.
	 */
