package buycorp.specification.rest.api.resource.v1_0.test;

import buycorp.specification.rest.api.client.http.HttpInvoker;
import buycorp.specification.rest.api.client.pagination.Page;
import buycorp.specification.rest.api.client.resource.v1_0.SpecificationResource;
...
public abstract class BaseSpecificationResourceTestCase {
	...
	@Test
	public void testGetAllSpecification() throws Exception {
		Assert.assertTrue(false);
	}
	...
	protected void assertContains(
		Object specification, List<Object> specifications) {
	...
	protected void assertEquals(Object specification1, Object specification2) {
		Assert.assertTrue(
	...
	protected void assertEquals(
		List<Object> specifications1, List<Object> specifications2) {

		Assert.assertEquals(specifications1.size(), specifications2.size());

		for (int i = 0; i < specifications1.size(); i++) {
			Object specification1 = specifications1.get(i);
			Object specification2 = specifications2.get(i);
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object specification1 : specifications1) {
			boolean contains = false;

			for (Object specification2 : specifications2) {
	...
	protected void assertValid(Object specification) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(Page<Object> page) {
		...
		java.util.Collection<Object> specifications = page.getItems();
	...
	protected boolean equals(Object specification1, Object specification2) {
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object specification) {
	...
	@Inject
	private buycorp.specification.rest.api.resource.v1_0.SpecificationResource
		_specificationResource;
