 ...
 */
@Generated("")
@GraphQLName("SpecificationUpdateObject")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SpecificationUpdateObject")
public class SpecificationUpdateObject implements Serializable {

	public static SpecificationUpdateObject toDTO(String json) {
		return ObjectMapperUtil.readValue(
			SpecificationUpdateObject.class, json);
	}

	public static SpecificationUpdateObject unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "buycorp.specification.rest.api.dto.v1_0.SpecificationUpdateObject",
		name = "x-class-name"
	)
