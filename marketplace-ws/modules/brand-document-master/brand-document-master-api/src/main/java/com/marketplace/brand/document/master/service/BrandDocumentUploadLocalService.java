...
/**
 * Provides the local service interface for BrandDocumentUpload. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BrandDocumentUploadLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BrandDocumentUploadLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.brand.document.master.service.impl.BrandDocumentUploadLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the brand document upload local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BrandDocumentUploadLocalServiceUtil} if injection and service tracking are not available.
	 */
