...
public class DashboardManagementToolbarProductSkuDisplayContext extends BaseManagementToolbarDisplayContext {

	public DashboardManagementToolbarProductSkuDisplayContext(LiferayPortletRequest liferayPortletRequest,
	...
	public String getSearchActionURL() {
		...
		String navigation = ParamUtil.getString(httpServletRequest, "dashboardEntry");
		String draftProductId = ParamUtil.getString(httpServletRequest, "draftProductId");
		portletURLStep.setMVCRenderCommandName("productSkus");
		portletURLStep.setParameter("draftProductId", draftProductId);
