...
/**
 * Provides the local service interface for Specification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SpecificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SpecificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.specification.master.service.impl.SpecificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the specification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SpecificationLocalServiceUtil} if injection and service tracking are not available.
	 */
