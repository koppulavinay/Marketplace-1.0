...
/**
 * Provides the local service interface for SpecFieldType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SpecFieldTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SpecFieldTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.specification.field.type.service.impl.SpecFieldTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the spec field type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SpecFieldTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
