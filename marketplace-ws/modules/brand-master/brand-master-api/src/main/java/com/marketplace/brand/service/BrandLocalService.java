...
public interface BrandLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.marketplace.brand.service.impl.BrandLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the brand local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BrandLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Brand addBrand(Brand brand, User user, ServiceContext serviceContext)
	...
	public List<Brand> findByFBYStatuses(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Brand> getBrandsByUuidAndCompanyId(String uuid, long companyId);
