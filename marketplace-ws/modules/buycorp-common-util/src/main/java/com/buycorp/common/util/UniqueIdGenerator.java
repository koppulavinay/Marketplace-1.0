...
/**
 * Unique id is composed of: current time stamp - 47 bits (millisecond precision
 * w/a custom epoch gives as 69 years) sequence number - 17 bits - rolls over
 * every 65536 with protection to avoid rollover in the same ms
 * 
