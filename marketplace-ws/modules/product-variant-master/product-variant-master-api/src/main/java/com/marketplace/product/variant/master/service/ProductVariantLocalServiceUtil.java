...
/**
 * Provides the local service utility for ProductVariant. This utility wraps
 * <code>com.marketplace.product.variant.master.service.impl.ProductVariantLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductVariantLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.marketplace.product.variant.master.service.impl.ProductVariantLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProductVariant addProductVariant(
		ProductVariant productVariant) {

		return getService().addProductVariant(productVariant);
	}
	 ...
	 */
	public static ProductVariant createProductVariant(long productVariantId) {
		return getService().createProductVariant(productVariantId);
	}
	 ...
	 */
	public static ProductVariant deleteProductVariant(long productVariantId)
		throws PortalException {

		return getService().deleteProductVariant(productVariantId);
	}
	 ...
	 * @return the product variant that was removed
	 */
	public static ProductVariant deleteProductVariant(
		ProductVariant productVariant) {

		return getService().deleteProductVariant(productVariant);
	}
	...
	public static ProductVariant fetchProductVariant(long productVariantId) {
		return getService().fetchProductVariant(productVariantId);
	}
	 ...
	 */
	public static ProductVariant fetchProductVariantByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchProductVariantByUuidAndGroupId(uuid, groupId);
	}
	...
	public static List<ProductVariant> findByVariantNameID(
		...
		return getService().findByVariantNameID(draftProductId, variantName);
	}
	 ...
	 * @throws PortalException if a product variant with the primary key could not be found
	 */
	public static ProductVariant getProductVariant(long productVariantId)
		throws PortalException {

		return getService().getProductVariant(productVariantId);
	}
	 ...
	 */
	public static ProductVariant getProductVariantByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getProductVariantByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<ProductVariant> getProductVariants(int start, int end) {
		return getService().getProductVariants(start, end);
	}
	 ...
	 */
	public static List<ProductVariant> getProductVariantsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getProductVariantsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProductVariantsCount() {
		return getService().getProductVariantsCount();
	}
	...
	public static ProductVariant updateProductVariant(
		...
		return getService().updateProductVariant(productVariant);
	}

	public static ProductVariantLocalService getService() {
		return _service;
	}

	private static volatile ProductVariantLocalService _service;
