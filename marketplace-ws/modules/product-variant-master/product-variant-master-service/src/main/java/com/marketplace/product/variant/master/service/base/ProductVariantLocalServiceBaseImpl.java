...
package com.marketplace.product.variant.master.service.base;
...
/**
 * Provides the base implementation for the product variant local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.marketplace.product.variant.master.service.impl.ProductVariantLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.marketplace.product.variant.master.service.impl.ProductVariantLocalServiceImpl
 * @generated
 */
public abstract class ProductVariantLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProductVariantLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductVariantLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductVariantLocalServiceUtil</code>.
	 */
	...
	public ProductVariant addProductVariant(ProductVariant productVariant) {
		...
		return productVariantPersistence.update(productVariant);
	}
	...
	public ProductVariant createProductVariant(long productVariantId) {
		return productVariantPersistence.create(productVariantId);
	}
	...
	public ProductVariant deleteProductVariant(long productVariantId)
		...
		return productVariantPersistence.remove(productVariantId);
	}
	...
	public ProductVariant deleteProductVariant(ProductVariant productVariant) {
		return productVariantPersistence.remove(productVariant);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return productVariantPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductVariant.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return productVariantPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return productVariantPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return productVariantPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return productVariantPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProductVariant fetchProductVariant(long productVariantId) {
		return productVariantPersistence.fetchByPrimaryKey(productVariantId);
	}
	...
	public ProductVariant fetchProductVariantByUuidAndGroupId(
		...
		return productVariantPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProductVariant getProductVariant(long productVariantId)
		...
		return productVariantPersistence.findByPrimaryKey(productVariantId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(productVariantLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProductVariant.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("productVariantId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			productVariantLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProductVariant.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ProductVariant>() {

				@Override
				public void performAction(ProductVariant productVariant)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, productVariant);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return productVariantPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProductVariantLocalServiceImpl#deleteProductVariant(ProductVariant) to avoid orphaned data");
		}

		return productVariantLocalService.deleteProductVariant(
			(ProductVariant)persistedModel);
	}

	@Override
	public BasePersistence<ProductVariant> getBasePersistence() {
		return productVariantPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return productVariantPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProductVariant> getProductVariantsByUuidAndCompanyId(
		...
		return productVariantPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProductVariant> getProductVariantsByUuidAndCompanyId(
		...
		return productVariantPersistence.findByUuid_C(
	...
	public ProductVariant getProductVariantByUuidAndGroupId(
		...
		return productVariantPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProductVariant> getProductVariants(int start, int end) {
		return productVariantPersistence.findAll(start, end);
	}
	...
	public int getProductVariantsCount() {
		return productVariantPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductVariantLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		productVariantLocalService = (ProductVariantLocalService)aopProxy;

		_setLocalServiceUtilService(productVariantLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductVariantLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = productVariantPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ProductVariantLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, productVariantLocalService);
		}
	...
	protected ProductVariantLocalService productVariantLocalService;

	@Reference
	protected ProductVariantPersistence productVariantPersistence;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductVariantLocalServiceBaseImpl.class);
